...
| SCREEN-onboarding | Onboarding | full-screen when `goals == null` | form | `OnboardingScreen` | 001-calorie-pwa |
| SCREEN-today | Today | tab `home` | composite | `TodayScreen` | 001-calorie-pwa |
| SCREEN-fridge | Fridge | tab `fridge` | collection | `FridgeScreen` | 001-calorie-pwa |
...
| SCREEN-add-food | AddFoodSheet | modal `add-food` | form | `AddFoodSheet` | 001-calorie-pwa |
| SCREEN-day-detail | DayDetailSheet | modal `day-detail` | detail | `DayDetailSheet` | 001-calorie-pwa |
